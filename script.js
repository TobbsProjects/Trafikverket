...
const infoArray = [
    {
        ...
        head: 'Framtid',
        text: 'IT. Mer och mer IT. Jag håller just nu på att spendera all min fritid på kod, främst HTML, CSS och JavaScript.'
    }
]
